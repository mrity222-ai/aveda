...
//               <motion.div
//                 key={service.title}
//                 whileHover={{ y: -8, boxShadow: '0 10px 20px rgba(0,0,0,0 }}
...
//                   <Card className="h-full cursor-pointer transition-transform">
//                     <CardHeader>
//                       <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-lg bg-primary/10 text-primary border border-primary/20">
//                         <Icon className="h-8 w-8" />
//                       </div>
...
//         <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
//           <div className="space-y-2">
//             <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl text-white" style={{ textShadow: '0 0 8px rgba(255,255,255,0.8)' }}>
//   What We Offer
// </h2>
//             <p className="max-w-3xl text-muted-foreground md:text-xl">
//               We provide a comprehensive suite of services to power your success, from innovative products to strategic marketing.
...
//               <motion.div
//                 key={service.title}
//                 whileHover={{ y: -8, boxShadow: '0 10px 20px rgba(0,0,0,)' }}
//                 initial={{ opacity: 0, y: 30 }}
//                 whileInView={{ opacity: 1, y: 0 }}
//                 transition={{ duration: 0.5, delay: index * 0.1 }}
//                 viewport={{ once: true }}
...
//                 <Link href={service.link}>
//                   <Card
//                     className="relative h-full cursor-pointer transition-transform text-white bg-cover bg-center overflow-hidden rounded-xl"
//                     style={{ backgroundImage: `url(${service.background})` }}
//                   >
//                     <div className="absolute inset-0 bg-black/50 z-0" />
//                     <div className="relative z-10 p-6">
//                       <CardHeader>
//                         <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-lg bg-white/20 text-white border border-white/30">
//                           <Icon className="h-8 w-8" />
//                         </div>
//                         <CardTitle>{service.title}</CardTitle>
//                       </CardHeader>
          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                <Link href={service.link}>
                  <Card
  className="relative h-full cursor-pointer bg-cover bg-center overflow-hidden rounded-2xl border border-white/10 shadow-xl backdrop-blur-md group transition-transform hover:-translate-y-2"
  style={{ backgroundImage: `url(${service.background})` }}
>
  <div className="absolute inset-0 bg-black/50 z-0" />

  <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 py-12">
    <div className="flex items-center justify-center h-16 w-16 mb-6 rounded-full bg-white/10 border border-white/20">
      <Icon className="h-10 w-10 text-white" />
    </div>
    <h3 className="text-white text-xl font-semibold leading-tight tracking-wide">
      {service.title}
    </h3>
  </div>
</Card>
